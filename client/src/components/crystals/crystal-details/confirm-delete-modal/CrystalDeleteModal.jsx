        ...
        <div className="modal-dialog animated zoomIn" role="document">
            <div className="modal-content">
                <div className="modal-header">
                    <h4 className="modal-title" id="deleteModalLabel">Are you sure you want to delete this {name} crystal?</h4>
...
export default CrystalDeleteModal;